...
type RunnerStatus struct {
	...
	IsNetworkEnabled     bool     `protobuf:"varint,17,opt,name=isNetworkEnabled,proto3" json:"isNetworkEnabled,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RunnerStatus) GetIsNetworkEnabled() bool {
	if m != nil {
		return m.IsNetworkEnabled
	}
	return false
}
...
var fileDescriptor_48eceea7e2abc593 = []byte{
	...
	,
}
