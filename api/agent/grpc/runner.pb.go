...
type CallFinished struct {
	...
	PullDuration         int64    `protobuf:"varint,10,opt,name=pullDuration,proto3" json:"pullDuration,omitempty"`
	ImageSize            int64    `protobuf:"varint,11,opt,name=imageSize,proto3" json:"imageSize,omitempty"`
...
func (m *CallFinished) GetPullDuration() int64 {
	if m != nil {
...
func (m *CallFinished) GetImageSize() int64 {
	if m != nil {
		return m.ImageSize
	}
	return 0
...
func init() { proto.RegisterFile("api/agent/grpc/runner.proto", fileDescriptor_48eceea7e2abc593) }
...
var fileDescriptor_48eceea7e2abc593 = []byte{
	...
	,
}
